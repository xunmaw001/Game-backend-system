...
public class YouxizhanghuView extends YouxizhanghuEntity implements Serializable {
	...
	public YouxizhanghuView() {

	}

	public YouxizhanghuView(YouxizhanghuEntity youxizhanghuEntity) {
		try {
			BeanUtils.copyProperties(this, youxizhanghuEntity);
