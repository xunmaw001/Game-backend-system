...
public class ChongzhirizhiView extends ChongzhirizhiEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 支付类型的值
		*/
		private String chongzhirizhiValue;
	...
	public ChongzhirizhiView() {

	}

	public ChongzhirizhiView(ChongzhirizhiEntity chongzhirizhiEntity) {
		try {
			BeanUtils.copyProperties(this, chongzhirizhiEntity);
			...
			* 获取： 支付类型的值
			*/
			public String getChongzhirizhiValue() {
				return chongzhirizhiValue;
			}
			/**
			* 设置： 支付类型的值
			*/
			public void setChongzhirizhiValue(String chongzhirizhiValue) {
				this.chongzhirizhiValue = chongzhirizhiValue;
			}
